...
const ToastMessage = ({
  ...
  return (
    <View
      ...
      className="flex-row items-start p-4 rounded-[24px] border border-white/5 bg-[#2C2C2E]/95 shadow-sm"
    >
      <View className="mr-4 mt-1">{getIcon()}</View>
      <View className="flex-1 mt-1 justify-center">
        {text1 && (
          <Text
            className="text-white font-semibold text-base font-inter mb-1"
            numberOfLines={1}
          >
            {text1}
          </Text>
